...
@android.arch.persistence.room.Database(entities = {User.class, Design.class, Manual.class, Project.class, FavouritedDesignsPerUser.class, ProjectPictureFileInfo.class, DesignPictureFileInfo.class}, version = 2)
