...
@android.arch.persistence.room.Database(entities = {User.class, Design.class, Manual.class, Project.class, ManualChapter.class, FavouritedDesign.class, ManualFileInfo.class, ProjectPictureFileInfo.class, DesignPictureFileInfo.class}, version = 9)
